    ...
    <Navbar/>
      <div className="flex min-h-screen justify-center items-center">
       ...
       <div className="relative">
            <div className="flex items-center border border-gray-400 rounded-lg overflow-hidden" style={{ width: "420px" }} > 
             <div className="p-4">
           ...
           <div className="relative mb-4 space-y-2">
            <div className="flex items-center space-x-2">
              <PhoneInput
                ...
                placeholder="Mobile"
                inputStyle={{
                  width: "100%", height: "50px", paddingLeft: "58px"
                }}
...
<div class="mb-4 space-y-3">
    <label class="flex items-center space-x-2">
      ...
      <span class="text-sm text-gray-600">
        I agree to the <a href="#" class="text-blue-600 font-medium">Terms of Use</a> and <a href="#" class="text-blue-600 font-medium">Privacy Policy</a>.
      </span>
    </label>
  </div>
  ...
  <div class="mt-6">
    <button
      class="w-full bg-orange-600 text-white text-lg font-medium py-3 rounded-lg hover:bg-orange-900 focus:ring focus:ring-blue-300"
  ...
  <p className="text-black-700">
    ...
    <NavLink
      to="/login"
      className="text-blue-600 font-medium  hover:text-orange-600 transition duration-300"
    >
      Sign In
    </NavLink>
  </p>
